...
#         df_path_20 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2\input_path.csv')
...
#
#         df_path_float_20 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2\input_path_float.csv')
...
#     # 调用另一个Python程序
# subprocess.call(['python', r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2/BTCG_HFN_cross_SF64_5F.py'])
...
# (2.1) draw box plan:
df_path_20_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_1.csv')
df_path_20_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_2.csv')
df_path_20_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_3.csv')
df_path_20_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_4.csv')
df_path_20_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_5.csv')
df_path_20_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_6.csv')
df_path_20_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_7.csv')
df_path_20_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_8.csv')
df_path_20_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_9.csv')
df_path_20_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_20_10.csv')
...
plt.text(1.0, median_loss_path_20_1+0.002, 'Median: {:.5f}'.format(median_loss_path_20_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_path_20_2+0.002, ' {:.5f}'.format(median_loss_path_20_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_path_20_3+0.002, ' {:.5f}'.format(median_loss_path_20_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_path_20_4+0.002, ' {:.5f}'.format(median_loss_path_20_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_path_20_5+0.002, ' {:.5f}'.format(median_loss_path_20_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_path_20_6+0.002, ' {:.5f}'.format(median_loss_path_20_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_path_20_7+0.002, ' {:.5f}'.format(median_loss_path_20_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_path_20_8+0.002, ' {:.5f}'.format(median_loss_path_20_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_path_20_9+0.002, ' {:.5f}'.format(median_loss_path_20_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_path_20_10+0.002, ' {:.5f}'.format(median_loss_path_20_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('20% OBD validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of path_proportion', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
...
# (2.1) draw box plan:
df_path_40_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_1.csv')
df_path_40_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_2.csv')
df_path_40_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_3.csv')
df_path_40_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_4.csv')
df_path_40_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_5.csv')
df_path_40_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_6.csv')
df_path_40_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_7.csv')
df_path_40_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_8.csv')
df_path_40_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_9.csv')
df_path_40_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_40_10.csv')
...
plt.text(1.0, median_loss_path_40_1+0.002, 'Median: {:.5f}'.format(median_loss_path_40_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_path_40_2+0.002, ' {:.5f}'.format(median_loss_path_40_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_path_40_3+0.002, ' {:.5f}'.format(median_loss_path_40_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_path_40_4+0.002, ' {:.5f}'.format(median_loss_path_40_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_path_40_5+0.002, ' {:.5f}'.format(median_loss_path_40_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_path_40_6+0.002, ' {:.5f}'.format(median_loss_path_40_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_path_40_7+0.002, ' {:.5f}'.format(median_loss_path_40_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_path_40_8+0.002, ' {:.5f}'.format(median_loss_path_40_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_path_40_9+0.002, ' {:.5f}'.format(median_loss_path_40_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_path_40_10+0.002, ' {:.5f}'.format(median_loss_path_40_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('40% OBD validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of path_proportion', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
handles = [Line2D([0], [0], color='dodgerblue', marker='o', lw=2)]
...
# (2.1) draw box plan:
df_path_60_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_1.csv')
df_path_60_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_2.csv')
df_path_60_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_3.csv')
df_path_60_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_4.csv')
df_path_60_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_5.csv')
df_path_60_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_6.csv')
df_path_60_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_7.csv')
df_path_60_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_8.csv')
df_path_60_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_9.csv')
df_path_60_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_60_10.csv')
...
plt.text(1.0, median_loss_path_60_1+0.002, 'Median: {:.5f}'.format(median_loss_path_60_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_path_60_2+0.002, ' {:.5f}'.format(median_loss_path_60_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_path_60_3+0.002, ' {:.5f}'.format(median_loss_path_60_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_path_60_4+0.002, ' {:.5f}'.format(median_loss_path_60_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_path_60_5+0.002, ' {:.5f}'.format(median_loss_path_60_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_path_60_6+0.002, ' {:.5f}'.format(median_loss_path_60_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_path_60_7+0.002, ' {:.5f}'.format(median_loss_path_60_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_path_60_8+0.002, ' {:.5f}'.format(median_loss_path_60_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_path_60_9+0.002, ' {:.5f}'.format(median_loss_path_60_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_path_60_10+0.002, ' {:.5f}'.format(median_loss_path_60_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('60% OBD validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of path_proportion', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
handles = [Line2D([0], [0], color='dodgerblue', marker='o', lw=2)]
...
# (2.1) draw box plan:
df_path_80_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_1.csv')
df_path_80_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_2.csv')
df_path_80_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_3.csv')
df_path_80_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_4.csv')
df_path_80_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_5.csv')
df_path_80_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_6.csv')
df_path_80_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_7.csv')
df_path_80_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_8.csv')
df_path_80_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_9.csv')
df_path_80_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_path_80_10.csv')
...
plt.text(1.0, median_loss_path_80_1+0.002, 'Median: {:.5f}'.format(median_loss_path_80_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_path_80_2+0.002, ' {:.5f}'.format(median_loss_path_80_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_path_80_3+0.002, ' {:.5f}'.format(median_loss_path_80_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_path_80_4+0.002, ' {:.5f}'.format(median_loss_path_80_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_path_80_5+0.002, ' {:.5f}'.format(median_loss_path_80_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_path_80_6+0.002, ' {:.5f}'.format(median_loss_path_80_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_path_80_7+0.002, ' {:.5f}'.format(median_loss_path_80_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_path_80_8+0.002, ' {:.5f}'.format(median_loss_path_80_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_path_80_9+0.002, ' {:.5f}'.format(median_loss_path_80_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_path_80_10+0.002, ' {:.5f}'.format(median_loss_path_80_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('80% OBD validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of path_proportion', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
handles = [Line2D([0], [0], color='dodgerblue', marker='o', lw=2)]
...
df_path_00 = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_path.csv')
...
plt.text(1.0, median_loss_path_20+0.0007, 'Median: {:.5f}'.format(median_loss_path_20), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_path_40+0.0002, ' {:.5f}'.format(median_loss_path_40), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_path_60+0.0003, ' {:.5f}'.format(median_loss_path_60), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_path_80+0.0005, ' {:.5f}'.format(median_loss_path_80), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
...
# draw mean -----
plt.axhline(mean_20, color='dodgerblue', linestyle='-.', linewidth = 1, label='Mean_20%')
plt.axhline(mean_40, color='dodgerblue', linestyle='-.', linewidth = 1, label='Mean_40%')
plt.axhline(mean_60, color='dodgerblue', linestyle='-.', linewidth = 1, label='Mean_60%')
plt.axhline(mean_80, color='dodgerblue', linestyle='-.', linewidth = 1, label='Mean_80%')

plt.text(1.2, mean_20-0.0007, 'Mean: {:.5f}'.format(mean_20), color='dodgerblue', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.2, mean_40-0.0007, ' {:.5f}'.format(mean_40), color='dodgerblue', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.2, mean_60-0.0008, ' {:.5f}'.format(mean_60), color='dodgerblue', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.2, mean_80-0.001, ' {:.5f}'.format(mean_80), color='dodgerblue', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('OBD validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error Average of path_proportion', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
...
for j in range(1,5):       # 20%/40%/60%/80%
    for i in range(1,11):   # 随机选取20%数据，藏住信息，作为验证集，共随机10次
        df_link = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2\input_link.csv')
        ...
        df_link_sensor = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2\input_link_sensor.csv')
...
# 2.1、绘制20%验证集，5次随机的absolute error
# (2.1) draw box plan:
df_link_20_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_1_link.csv')
df_link_20_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_2_link.csv')
df_link_20_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_3_link.csv')
df_link_20_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_4_link.csv')
df_link_20_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_5_link.csv')
df_link_20_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_6_link.csv')
df_link_20_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_7_link.csv')
df_link_20_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_8_link.csv')
df_link_20_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_9_link.csv')
df_link_20_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_20_10_link.csv')
...
plt.text(1.0, median_loss_link_20_1+0.3, 'Median: {:.5f}'.format(median_loss_link_20_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_link_20_2+0.3, ' {:.5f}'.format(median_loss_link_20_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_link_20_3+0.3, ' {:.5f}'.format(median_loss_link_20_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_link_20_4+0.3, ' {:.5f}'.format(median_loss_link_20_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_link_20_5+0.3, ' {:.5f}'.format(median_loss_link_20_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_link_20_6+0.3, ' {:.5f}'.format(median_loss_link_20_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_link_20_7+0.3, ' {:.5f}'.format(median_loss_link_20_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_link_20_8+0.3, ' {:.5f}'.format(median_loss_link_20_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_link_20_9+0.3, ' {:.5f}'.format(median_loss_link_20_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_link_20_10+0.3, ' {:.5f}'.format(median_loss_link_20_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('20% sensor validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of link_count', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
...
# 2.2、绘制40%验证集，5次随机的absolute error
# (2.1) draw box plan:
df_link_40_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_1_link.csv')
df_link_40_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_2_link.csv')
df_link_40_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_3_link.csv')
df_link_40_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_4_link.csv')
df_link_40_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_5_link.csv')
df_link_40_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_6_link.csv')
df_link_40_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_7_link.csv')
df_link_40_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_8_link.csv')
df_link_40_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_9_link.csv')
df_link_40_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_40_10_link.csv')
...
plt.text(1.0, median_loss_link_40_1+0.3, 'Median: {:.5f}'.format(median_loss_link_40_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_link_40_2+0.3, ' {:.5f}'.format(median_loss_link_40_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_link_40_3+0.3, ' {:.5f}'.format(median_loss_link_40_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_link_40_4+0.3, ' {:.5f}'.format(median_loss_link_40_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_link_40_5+0.3, ' {:.5f}'.format(median_loss_link_40_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_link_40_6+0.3, ' {:.5f}'.format(median_loss_link_40_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_link_40_7+0.3, ' {:.5f}'.format(median_loss_link_40_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_link_40_8+0.3, ' {:.5f}'.format(median_loss_link_40_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_link_40_9+0.3, ' {:.5f}'.format(median_loss_link_40_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_link_40_10+0.3, ' {:.5f}'.format(median_loss_link_40_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('40% sensor validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of link_count', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
handles = [Line2D([0], [0], color='salmon', marker='o', lw=2)]
...
# (2.1) draw box plan:
df_link_60_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_1_link.csv')
df_link_60_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_2_link.csv')
df_link_60_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_3_link.csv')
df_link_60_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_4_link.csv')
df_link_60_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_5_link.csv')
df_link_60_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_6_link.csv')
df_link_60_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_7_link.csv')
df_link_60_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_8_link.csv')
df_link_60_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_9_link.csv')
df_link_60_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_60_10_link.csv')
...
plt.text(1.0, median_loss_link_60_1+0.3, 'Median: {:.5f}'.format(median_loss_link_60_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_link_60_2+0.3, ' {:.5f}'.format(median_loss_link_60_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_link_60_3+0.3, ' {:.5f}'.format(median_loss_link_60_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_link_60_4+0.3, ' {:.5f}'.format(median_loss_link_60_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_link_60_5+0.3, ' {:.5f}'.format(median_loss_link_60_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_link_60_6+0.3, ' {:.5f}'.format(median_loss_link_60_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_link_60_7+0.3, ' {:.5f}'.format(median_loss_link_60_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_link_60_8+0.3, ' {:.5f}'.format(median_loss_link_60_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_link_60_9+0.3, ' {:.5f}'.format(median_loss_link_60_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_link_60_10+0.3, ' {:.5f}'.format(median_loss_link_60_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('60% sensor validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of link_count', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
handles = [Line2D([0], [0], color='salmon', marker='o', lw=2)]
...
# 2.4、绘制80%验证集，5次随机的absolute error
# (2.1) draw box plan:
df_link_80_1 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_1_link.csv')
df_link_80_2 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_2_link.csv')
df_link_80_3 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_3_link.csv')
df_link_80_4 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_4_link.csv')
df_link_80_5 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_5_link.csv')
df_link_80_6 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_6_link.csv')
df_link_80_7 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_7_link.csv')
df_link_80_8 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_8_link.csv')
df_link_80_9 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_9_link.csv')
df_link_80_10 = pd.read_csv(r'E:\02BTCG_cross_SF64\12BTCG_cross_SF_all_5F_validation_v2_random10\output_link_80_10_link.csv')
...
plt.text(1.0, median_loss_link_80_1+0.3, 'Median: {:.5f}'.format(median_loss_link_80_1), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_link_80_2+0.3, ' {:.5f}'.format(median_loss_link_80_2), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_link_80_3+0.3, ' {:.5f}'.format(median_loss_link_80_3), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_link_80_4+0.3, ' {:.5f}'.format(median_loss_link_80_4), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(5.0, median_loss_link_80_5+0.3, ' {:.5f}'.format(median_loss_link_80_5), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(6.0, median_loss_link_80_6+0.3, ' {:.5f}'.format(median_loss_link_80_6), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(7.0, median_loss_link_80_7+0.3, ' {:.5f}'.format(median_loss_link_80_7), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(8.0, median_loss_link_80_8+0.3, ' {:.5f}'.format(median_loss_link_80_8), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(9.0, median_loss_link_80_9+0.3, ' {:.5f}'.format(median_loss_link_80_9), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(10.0, median_loss_link_80_10+0.3, ' {:.5f}'.format(median_loss_link_80_10), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('80% sensor validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of link_count', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
handles = [Line2D([0], [0], color='salmon', marker='o', lw=2)]
...
# 3、计算0%、20%、40%、60%、80%验证集 5次的平均值，分别绘制5个箱型图，每个箱型图是eg.20%的5个平均值，横坐标是0%、20%、40%、60%、80%，纵坐标是AE平均值
# （3.1）calculate the AE average of 0%
df_link_00 = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_link.csv')
...
plt.text(1.0, median_loss_link_20+0.3, 'Median: {:.5f}'.format(median_loss_link_20), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.0, median_loss_link_40+0.2, ' {:.5f}'.format(median_loss_link_40), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.0, median_loss_link_60+0.2, ' {:.5f}'.format(median_loss_link_60), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.0, median_loss_link_80+0.1, ' {:.5f}'.format(median_loss_link_80), fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
...
# draw mean -----
plt.axhline(mean_20, color='indianred', linestyle='-.', linewidth = 1, label='Mean_20%')
plt.axhline(mean_40, color='indianred', linestyle='-.', linewidth = 1, label='Mean_40%')
plt.axhline(mean_60, color='indianred', linestyle='-.', linewidth = 1, label='Mean_60%')
plt.axhline(mean_80, color='indianred', linestyle='-.', linewidth = 1, label='Mean_80%')

plt.text(1.2, mean_20-0.55, 'Mean: {:.5f}'.format(mean_20), color='indianred', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(2.2, mean_40+0.1, ' {:.5f}'.format(mean_40), color='indianred', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(3.2, mean_60+0.25, ' {:.5f}'.format(mean_60), color='indianred', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来
plt.text(4.2, mean_80+0.26, ' {:.5f}'.format(mean_80), color='indianred', fontproperties='Times New Roman', size=12, ha='center', va='bottom')     # 将箱型图的中位数标记出来

fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('sensor validation set', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error Average of link_count', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
...
fig = plt.gcf()
fig.set_size_inches(8, 6)  # 设置保存图像的显示大小 宽度为 10英寸，高度为 8英寸
plt.xlabel('Absolute Error Average of link_count', fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})
plt.ylabel('Frequency', fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})
font = fm.FontProperties(family='Times New Roman', style='normal', size=12)
plt.legend(loc='upper right', ncol=2, prop=font)
