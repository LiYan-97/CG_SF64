...
df_5F = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_loss.csv')
df_4F = pd.read_csv(r'E:\02BTCG_cross_SF64\13BTCG_cross_SF_contrast_no_count_4F\output_loss.csv')
...
df_5F_survey = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_ozone.csv')
df_5F_mobile = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_od.csv')
df_5F_OBD = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_path.csv')
df_5F_monitoring = pd.read_csv(r'E:\02BTCG_cross_SF64\11BTCG_cross_SF_all_5F\output_link.csv')

df_4F_survey = pd.read_csv(r'E:\02BTCG_cross_SF64\13BTCG_cross_SF_contrast_no_count_4F\output_ozone.csv')
df_4F_mobile = pd.read_csv(r'E:\02BTCG_cross_SF64\13BTCG_cross_SF_contrast_no_count_4F\output_od.csv')
df_4F_OBD = pd.read_csv(r'E:\02BTCG_cross_SF64\13BTCG_cross_SF_contrast_no_count_4F\output_path.csv')
df_4F_monitoring = pd.read_csv(r'E:\02BTCG_cross_SF64\13BTCG_cross_SF_contrast_no_count_4F\output_link.csv')
...
plt.xlabel('Survey', labelpad=7.5, fontweight = 'bold', fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
# plt.xlabel('Survey', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变横坐标轴标题字体  labelpad=10表示坐标标题距离坐标轴的垂直距离
plt.ylabel('Absolute Error of ozone_generation', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
# plt.axis([-10, 310, -1, 41])  # 改变xy坐标轴范围
# plt.axis([-1, 101, -1, 51])  # 改变xy坐标轴范围
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
plt.savefig('Contrast box-plot of Survey.png', dpi=300, format='png')
plt.show()
...
plt.xlabel('Mobile', labelpad=7.5, fontweight = 'bold', fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})
plt.ylabel('Absolute Error of OD_flow', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
plt.savefig('Contrast box-plot of Mobile.png', dpi=300, format='png')
plt.show()
...
plt.xlabel('OBD', labelpad=7.5, fontweight = 'bold', fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})
plt.ylabel('Absolute Error of path_proportion', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
plt.savefig('Contrast box-plot of OBD.png', dpi=300, format='png')
plt.show()
...
plt.xlabel('Monitoring', labelpad=7.5, fontweight = 'bold', fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})
plt.ylabel('Absolute Error of link_count', labelpad=7.5, fontdict={'family': 'Times New Roman', 'size': 12, 'color': 'k'})  # 改变纵坐标轴标题字体
plt.xticks(fontproperties='Times New Roman', size=12)
plt.yticks(fontproperties='Times New Roman', size=12)
plt.savefig('Contrast box-plot of Monitoring.png', dpi=300, format='png')
plt.show()
